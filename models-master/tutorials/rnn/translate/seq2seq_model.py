...
sys.path.append("/Users/David/Documents/research/tensorflow/tensorflow-master/tensorflow/contrib/legacy_seq2seq/python/ops/")
  ...
  def step(self, session, encoder_inputs, decoder_inputs, target_weights,
    ...
    if not forward_only:
      ...
      output_feed = [self.losses[bucket_id],
                     self.states[bucket_id]]  # Loss for this batch.
